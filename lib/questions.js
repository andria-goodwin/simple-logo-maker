...
// functions to validate user input if done more than once
...
// Questions class holding an array of questions and .then to write file
class Questions {
    ...
    run() {
        ...
        // switch case depending on shape type sets shape color, text, and text color to each shape for logo
        .then (({shape, shapeColor, text, textColor}) => {
            ...
            // bringing in SVG data
            const svg = new SVG();
            svg.setText(text,textColor);
            svg.setShape(shapeType);
            // render new file in examples folder
